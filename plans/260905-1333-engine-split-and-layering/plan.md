...
|---|---|---|---|
| 1 | [Carve the engine into modules, no behaviour change](./phase-01-start.md) | pending | — |
| 2 | [Unbundle product preferences](./phase-02-unbundle-product-preferences.md) | pending | 1 |
| 3 | [Session crate and injected defaults](./phase-03-session-crate-and-injected-defaults.md) | pending | 2 |
